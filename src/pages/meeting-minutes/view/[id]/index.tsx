...
import { getMeetingMinutesById } from 'apiSdk/meeting-minutes';
import { MeetingMinutesInterface } from 'interfaces/meeting-minutes';

function MeetingMinutesViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('meeting_minutes', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/meeting-minutes/edit/${id}`} passHref legacyBehavior>
                    <Button
