...
import { getChatbotCreatorById, updateChatbotCreatorById } from 'apiSdk/chatbot-creators';
...
function ChatbotCreatorEditPage() {
  ...
  const handleSubmit = async (values: ChatbotCreatorInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateChatbotCreatorById(id, values);
      mutate(updated);
      resetForm();
