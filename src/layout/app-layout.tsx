...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'marketing-specialist'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    {
      name: 'Chatbot Creators',
      path: '/chatbot-creators',
      entity: 'chatbot_creator',
      service: AccessServiceEnum.PROJECT,
      icon: FiMessageCircle,
    },
    { name: 'Crms', path: '/crms', entity: 'crm', service: AccessServiceEnum.PROJECT, icon: FiPhoneCall },
    {
      name: 'Form Generators',
      path: '/form-generators',
